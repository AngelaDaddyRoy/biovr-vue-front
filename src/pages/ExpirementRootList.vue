            ...
            <table class="table table-responsive">
              ...
              <tbody>
                <tr v-for="r in expmRoots">
                  ...
                  <td>
                    <input type="text" class="form-control" v-model="r.name">
                  </td>
                  <td>
                    <input type="text" class="form-control" v-model="r.description" data-toggle="tooltip" data-placement="bottom" :title="r.description"></input>
                  </td>
                  <td>
                    <img v-if="r.coverImage!=undefined" :src="r.coverImage" @click="showImage(r)" class="table-image">
                    </i>
                    <span v-else>无</span>
                  </td>
                  <td>
                    <a class="btn btn-sm btn-info" @click="openSetImageWindow(r)">封面</a>
                    <button class="btn btn-sm btn-warning" @click="goSubExpms(r)">子实验</button>
...
export default {
  ...
  methods: {
    ...
    goSubExpms:function(rExpm){
      this.$router.push({name:'ExpmsOfRoot',params:{id:rExpm.id}})
    }
  }
}
</script>